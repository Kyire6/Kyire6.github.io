	...
	return function (e) {
		...
		e.exports = function (e, t) {
			...
			for (var p = 1, d = !0; p < n.length; p += 1) {
				...
				if ("constructor" !== v && d || (u = !0), o += "." + v, l = "%" + o + "%", y(h, l)) c = h[l];
				else if (null != c) {
					if (!(v in c)) {
		...
		function i(e, t, n) {
			...
			e: for (c = 0; c < u; c++) {
				...
				if (!1 === s) {
					...
					if (">" === d) {
						i += n(e.slice(a, s)), p = e.slice(s, c + 1), f = r(p), i += t(s, i.length, f, p, o(p)), a = c + 1, s = !1;
						continue
					}
					if ('"' === d || "'" === d)
						for (var h = 1, v = e.charAt(c - h);
							"" === v.trim() || "=" === v;) {
							if ("=" === v) {
								l = d;
								continue e
		...
		function a(e, t) {
			...
			return r < e.length && (!1 === i ? n(e.slice(r)) : n(i, u(f.trim(e.slice(r))))), f.trim(o.join(" "))
		}
		...
		*/
			...
			function n(e) {
				...
				if (e && e.nodeName && "TEXTAREA" === e.nodeName && !i.has(e)) {
					var s = null,
						...
						f = function (t) {
							window.removeEventListener("resize", u, !1), e.removeEventListener("input", o, !1), e.removeEventListener("keyup", o, !1), e.removeEventListener("autosize:destroy", f, !1), e.removeEventListener("autosize:update", o, !1), Object.keys(t).forEach(function (n) {
								e.style[n] = t[n]
							}), i.delete(e)
						}.bind(e, {
					...
					e.addEventListener("autosize:destroy", f, !1), "onpropertychange" in e && "oninput" in e && e.addEventListener("keyup", o, !1), window.addEventListener("resize", u, !1), e.addEventListener("input", o, !1), e.addEventListener("autosize:update", o, !1), e.style.overflowX = "hidden", e.style.wordWrap = "break-word", i.set(e, {
							destroy: f,
							update: o
						}),
						function () {
		...
		o.prototype.init = function (e) {
			...
			var t = this;
			return e && (e = S.default.extend(h.CONFIG, e), t.i18n = (0, f.default)(e.lang || S.default.lang, e.langMode), t.cfg = e, d.default.maps = !!e.emojiMaps && e.emojiMaps || d.default.maps, d.default.cdn = !!e.emojiCDN && e.emojiCDN || d.default.cdn, t._init()), t
			...
			try {
				...
				var u = I.ds,
					f = r ? "&q=" + h.RandomStr : "";
				I.params = "?d=" + (u.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + f, I.hide = "hide" === n, I.cdn = /^https?\:\/\//.test(o) ? o : I.cdn, e.cfg.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, c && (0, b.recordIPFn)(function (e) {
					return E.ip = e
				});
				var p = e.cfg.el || null,
					d = (0, S.default)(p);
				if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
					e.$el = (0, S.default)(p), e.$el.addClass("v").attr("data-class", "v"), I.hide && e.$el.addClass("hide-avatar"), e.cfg.meta = (e.cfg.guest_info || e.cfg.meta || h.defaultMeta).filter(function (e) {
					...
					e.$loading = {
						show: function (t) {
							return t && k.show() || w.show(), e.$nodata.hide(), e
						},
						hide: function () {
							return k.hide(), w.hide(), 0 === e.$el.find(".vcard").length && e.$nodata.show(), e
						}
					}
				}(0, y.default)(e.cfg, function (t) {
					var n = (0, S.default)(".valine-comment-count"),
						r = 0;
					! function t(n) {
						var o = n[r++];
						if (o) {
		...
		var z = function (e, t) {
			...
			C = {
				add: function (e, t) {
					var n = this,
						r = (0, S.default)(".leancloud_visitors,.leancloud-visitors");
					if (1 === r.length) {
						var o = r[0],
							i = decodeURI((0, S.default)(o).attr("id")),
							a = (0, S.default)(o).attr("data-flag-title"),
							s = encodeURI(i),
							l = {
								el: o,
								url: i,
				...
				show: function (e, t) {
					...
					if (t.forEach(function (e) {
							...
							t && t.text("0"), n.push(/\%/.test((0, S.default)(e).attr("id")) ? decodeURI((0, S.default)(e).attr("id")) : (0, S.default)(e).attr("id"))
						}), n.length) {
		...
		o.prototype.Q = function (e) {
			...
			e.$emoji = {
				...
				show: function () {
					return T ? (e.$emoji.hide(), o.addClass("actived"), n.html(T).show(), P()) : e.$preview.hide(), e.$preview
				},
				hide: function () {
			...
			var f = function (t) {
				...
				r || e.$preview.hide(), T != r && (T = r, o.hasClass("actived") > -1 && T != n.html() && n.html(T), (0, c.default)(t[0]), P())
			};
			...
			for (var y in m) m.hasOwnProperty(y) && function () {
				...
				v[t] = n, n.on("input change blur propertychange", function (r) {
					e.cfg.enableQQ && "blur" === r.type && "nick" === t && (isNaN(n.val()) ? S.default.store.get(h.QQCacheKey) && S.default.store.get(h.QQCacheKey).nick != n.val() && (S.default.store.remove(h.QQCacheKey), E.nick = n.val(), E.mail = "", E.QQAvatar = "") : (0, b.fetchQQFn)(n.val(), function (e) {
						var t = e.nick || n.val(),
							r = e.qq + "@qq.com";
						(0, S.default)(".vnick").val(t), (0, S.default)(".vmail").val(r), E.nick = t, E.mail = r, E.QQAvatar = e.pic
			...
			var O = function () {
				...
				o.limit(t), o.skip((n - 1) * t), o.find().then(function (o) {
					if (k.skip = k.size, o && o.length) {
						...
						}).catch(function (e) {}), t * n < r ? _.show() : _.hide(), P()
					} else e.$nodata.show();
					e.$loading.hide()
				}).catch(function (t) {
			...
			var $ = function (t, n, r) {
					var qq_img = I.cdn + (0, s.default)(t.get("mail")) + I.params; //默认gravator头像接口
					if (e.get("mail").indexOf("@qq.com") >= 0) {
						...
						if (result !== null) {
							qq_img = "//q2.qlogo.cn/headimg_dl?dst_uin=" + prefix + "&spec=100";
						}
					}
					var o = (0, S.default)('<div class="vcard" id="' + t.id + '"></div>'),
						i = t.get("ua"),
						a = "";
					i && !/ja/.test(e.cfg.lang) && (i = S.default.detect(i), a = i.os ? '<span class="vsys">' + i.browser + " " + i.version + '</span> <span class="vsys">' + i.os + " " + i.osVersion + "</span>" : ""), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
					var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
						...
						f = I.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (qq_img) + '">',
						p = f + '<div class="vh"><div class="vhead">' + u + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, g.default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, j.default)(t.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + t.id + '"></div><div class="vquote" data-self-id="' + t.id + '"></div></div>';
					o.html(p);
					var d = o.find(".vat");
				...
				C = function (t, n) {
					t.on("click", function (r) {
						...
						(0, S.default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(), z = {
				...
				P = function () {
					setTimeout(function () {
						try {
							e.cfg.mathjax && "MathJax" in window && "version" in window.MathJax && (/^3.*/.test(window.MathJax.version) && MathJax.typeset() || MathJax.Hub.Queue(["Typeset", MathJax.Hub, document.querySelector(".v")])), "renderMathInElement" in window && renderMathInElement((0, S.default)(".v")[0], {
								delimiters: [{
									left: "$$",
									right: "$$",
									display: !0
			...
			! function (t) {
				...
				E.comment = "", v.comment.val(""), f(v.comment), v.comment.attr("placeholder", e.cfg.placeholder), z = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), T = ""
			};
			var M = e.$el.find(".vsubmit"),
				F = function (t) {
					if (e.cfg.requiredFields.indexOf("nick") > -1 && E.nick.length < 3) return v.nick[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
					if (e.cfg.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail)) return v.mail[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(3e3);
				...
				N = function () {
					...
					for (var o in E)
						...
						try {
							z.rid ? $(t, (0, S.default)('.vquote[data-self-id="' + z.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), $(t, e.$el.find(".vcards")), k.skip++), M.removeAttr("disabled"), e.$loading.hide(), e.reset()
						} catch (t) {
			...
			M.on("click", F), (0, S.default)(document).on("keydown", function (e) {
				...
				((e.ctrlKey || e.metaKey) && 13 === t && F(), 9 === t) && ("veditor" == (document.activeElement.id || "") && (e.preventDefault(), w(i[0], "    ")))
			}).on("paste", function (e) {
				...
				B = function t(n, r) {
					...
					if (o > 0) {
						...
						w(i[0], s), D(a, function (l) {
							500 != l.code ? (i.val(i.val().replace(s, "![" + a.name + "](" + l.data.url + ")\r\n")), (0, c.default)(i[0]), ++r < o ? t(n, r) : M.removeAttr("disabled")) : (i.val(i.val().replace(s, "")), (0, c.default)(i[0]), e.$el.find(".status-bar").text(l.msg).empty(3e3), M.removeAttr("disabled"))
						})
					}
				},
				D = function (e, t) {
		...
		h.code = function (e, t) {
			...
			highlight: function (e, t) {
				return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e).value : (0, c.default)(e)
			},
			gfm: !0,
			tables: !0,
			breaks: !0,
		...
		t.default = function (e) {
			return e = (0, o.default)({
				...
				if ("jsonp" == e.method) {
					...
					return e.body.callback = r, e.body.t = Date.now(), s.src = e.url + "?" + a(e.body), window[r] = function (e) {
				...
				e.url = e.url + "?" + ("get" == e.method ? a(e.body) : ""), l.open(e.method || "get", e.url, !0), l.onload = function () {
		...
		function c(e, t) {
			...
			if (2 === n.length && i(e) && o(t))
				for (var s = 0, u = e.length; s < u; s++) a = t(e[s], f.get(e[s])), c.set(e[s], a);
			return c
		}
		t.__esModule = !0;
		...
		i.prototype.process = function (e) {
			...
			return s(e, function (e, t, n, s, c) {
				var u = o[n],
					f = !1;
				if (!0 === u ? f = u : "function" == typeof u ? f = u(s) : u instanceof RegExp && (f = u.test(s)), !0 !== f && (f = !1), s = l(n, s)) {
					var p = {
						position: t,
						sourcePosition: e,
						source: c,
		...
		e.exports = function (e) {
			...
			var n;
			if (r && (Symbol.toPrimitive ? n = c(e, Symbol.toPrimitive) : s(e) && (n = Symbol.prototype.valueOf)), void 0 !== n) {
				var i = n.call(e, t);
				if (o(i)) return i;
		...
		function o(e, t) {
			function n() {
				"\x3c!--" === e.substr(0, 4) ? d() : p.test(e) ? o(c, g) : f.test(e) && o(l, v), h()
			}
		...
		function r(e, t) {
			...
			function r(e, t, r) {
				function s(e) {
					...
					var s, u = t[e],
						f = (v.allowedClasses || {})[l] || [],
						p = (v.allowedAttributes || {})[l] || [],
						d = i(e);
					"class" === d && -1 === p.indexOf(d) ? (u = u.split(" ").filter(r).join(" ").trim(), s = u.length) : s = -1 !== p.indexOf(d) && (!0 !== a.uris[d] || c(u)), s && (n(" "), n(e), "string" == typeof u && (n('="'), n(o.encode(u)), n('"')))
				}
				var l = i(e);
			...
			function l(e) {
				var t = i(e); - 1 !== (v.allowedTags || []).indexOf(t) && !1 === h.ignoring ? (n("</"), n(t), n(">")) : p(t)
			}
		...
		! function (t, n) {
			...
			function s(e, t) {
				...
				var n = {
					replace: function (t, r) {
						return r = r.source || r, r = r.replace(E, "$1"), e = e.replace(t, r), n
					},
					getRegex: function () {
			...
			function c(e, t) {
				z[" " + e] || (C.test(e) ? z[" " + e] = e + "/" : z[" " + e] = p(e, "/", !0)), e = z[" " + e];
				var n = -1 === e.indexOf(":");
			...
			function w(e, t, n) {
				...
				if ("function" == typeof t && (n = t, t = null), t = ue({}, w.defaults, t || {}), fe(t), n) {
					var r, o = t.highlight;
					try {
						r = ee.lex(e, t)
					} catch (e) {
				...
				try {
					...
					if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", t.silent) return "<p>An error occurred:</p><pre>" + pe(e.message + "", !0) + "</pre>";
					throw e
				}
			}
			var x = function (e) {
				...
				q = function () {
					...
					return t.space = function (e) {
						...
						if (t) {
							...
							return s = s.trim(), /^</.test(s) && (s = this.options.pedantic && !/>$/.test(n) ? s.slice(1) : s.slice(1, -1)), g(t, {
						...
						if (n) {
							var r, o;
							return "@" === n[2] ? (r = B(this.options.mangle ? t(n[1]) : n[1]), o = "mailto:" + r) : (r = B(n[1]), o = r), {
								type: "link",
								raw: n[0],
								text: r,
								href: o,
						...
						if (n = this.rules.inline.url.exec(e)) {
							var r, o;
							if ("@" === n[2]) r = B(this.options.mangle ? t(n[0]) : n[0]), o = "mailto:" + r;
							else {
								var i;
								do {
			...
			}), K.gfm.url = W(K.gfm.url, "i").replace("email", K.gfm._extended_email).getRegex(), K.breaks = V({}, K.gfm, {
			...
			var G = {
				...
				ee = function () {
					function e(e) {
						this.tokens = [], this.tokens.links = Object.create(null), this.options = e || Z, this.options.tokenizer = this.options.tokenizer || new q, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options;
						var t = {
							block: J.normal,
							inline: X.normal
						};
						this.options.pedantic ? (t.block = J.pedantic, t.inline = X.pedantic) : this.options.gfm && (t.block = J.gfm, this.options.breaks ? t.inline = X.breaks : t.inline = X.gfm), this.tokenizer.rules = t
					}
					e.lex = function (t, n) {
					...
					return n.lex = function (e) {
						...
						for (var r, o, i, a; e;)
							...
							else if (r = this.tokenizer.code(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : (a = t[t.length - 1], a.raw += "\n" + r.raw, a.text += "\n" + r.text);
						...
						else if (r = this.tokenizer.text(e, t)) e = e.substring(r.raw.length), r.type ? t.push(r) : (a = t[t.length - 1], a.raw += "\n" + r.raw, a.text += "\n" + r.text);
						else if (e) {
						...
						if (this.tokens.links) {
							...
							if (c.length > 0)
								for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(l));) c.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, i.index) + "[" + Y("a", i[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
						}
						...
						for (; e;)
							if (a || (s = ""), a = !1, o = this.tokenizer.escape(e)) e = e.substring(o.raw.length), t.push(o);
						...
						else if (o = this.tokenizer.strong(e, l, s)) e = e.substring(o.raw.length), o.tokens = this.inlineTokens(o.text, [], n, r), t.push(o);
						else if (o = this.tokenizer.em(e, l, s)) e = e.substring(o.raw.length), o.tokens = this.inlineTokens(o.text, [], n, r), t.push(o);
						...
						else if (o = this.tokenizer.autolink(e, b)) e = e.substring(o.raw.length), t.push(o);
						else if (n || !(o = this.tokenizer.url(e, b))) {
							if (o = this.tokenizer.inlineText(e, r, y)) e = e.substring(o.raw.length), s = o.raw.slice(-1), a = !0, t.push(o);
							else if (e) {
				...
				ce = function () {
					function e(e) {
						this.options = e || se, this.options.renderer = this.options.renderer || new oe, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new ie, this.slugger = new ae
					}
					...
					return t.parse = function (e, t) {
						void 0 === t && (t = !0);
						var n, r, o, i, a, s, l, c, u, f, p, d, h, v, g, m, y, b, w = "",
							x = e.length;
						for (n = 0; n < x; n++) switch (f = e[n], f.type) {
							...
							case "table":
								...
								for (c += this.renderer.tablerow(l), u = "", i = f.cells.length, r = 0; r < i; r++) {
							...
							case "blockquote":
								...
								continue;
							case "list":
								for (p = f.ordered, d = f.start, h = f.loose, i = f.items.length, u = "", r = 0; r < i; r++) g = f.items[r], m = g.checked, y = g.task, v = "", g.task && (b = this.renderer.checkbox(m), h ? g.tokens.length > 0 && "text" === g.tokens[0].type ? (g.tokens[0].text = b + " " + g.tokens[0].text, g.tokens[0].tokens && g.tokens[0].tokens.length > 0 && "text" === g.tokens[0].tokens[0].type && (g.tokens[0].tokens[0].text = b + " " + g.tokens[0].tokens[0].text)) : g.tokens.unshift({
									type: "text",
									text: b
			...
			}, w.Parser = ce, w.parser = ce.parse, w.Renderer = oe, w.TextRenderer = ie, w.Lexer = ee, w.lexer = ee.lex, w.Tokenizer = q, w.Slugger = ae, w.parse = w, w
		})
	}, function (e, t, n) {
		"use strict";
		...
		function c(e) {
			...
			this.onMissingKey = "function" == typeof t.onMissingKey ? t.onMissingKey : n, this.warn = t.warn || v, this.tokenRegex = s(t.interpolation), this.pluralRules = t.pluralRules || w
		}
		var u = n(48),
			f = n(100),
			p = n(105),
			...
			x = function () {
				...
				return function (t, n) {
					var r = e[n];
					return r && !t.pluralTypes[r] && (r = null, e[n] = r), r || (r = o(t, n)) && (e[n] = r), r
				}
			}(),
			k = /%\{(.*?)\}/g;
		...
		*/
		...
		function z(e, t) {
			...
			if ("function" == typeof X)
				for (var u = 0; u < s.length; u++) te.call(e, s[u]) && r.push("[" + t(s[u]) + "]: " + t(e[s[u]], e));
			return r
		}
		...
		e.exports = function e(t, n, A, C) {
			function P(t, n, r) {
				if (n && (C = C.slice(), C.push(n)), r) {
					...
					return h(F, "quoteStyle") && (o.quoteStyle = F.quoteStyle), e(t, o, A + 1, C)
				}
				return e(t, F, A + 1, C)
			}
			var F = n || {};
			...
			var D = T(F, A);
			if (void 0 === C) C = [];
			else if (m(C, t) >= 0) return "[Circular]";
			...
			if (S(t)) {
				...
				return V += ">", t.childNodes && t.childNodes.length && (V += "..."), V += "</" + String(t.nodeName).toLowerCase() + ">"
			}
			if (i(t)) {
		...
		if (!Object.keys) {
			...
			r = function (e) {
				...
				if (r && e.length > 0)
					...
					for (var g in e) p && "prototype" === g || !o.call(e, g) || f.push(String(g));
				if (l)
					for (var m = h(e), y = 0; y < u.length; ++y) m && "constructor" === u[y] || !o.call(e, u[y]) || f.push(u[y]);
				return f
			}
		}
		e.exports = r
